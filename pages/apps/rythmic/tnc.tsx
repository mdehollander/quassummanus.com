...
const RythmicTermsAndConditions = props => {
  return (
    <article className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="This is terms and conditions page for rythmic app."
        />
      </Head>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Antoni
        Silvestrovic.
      </p>
      <p>
        Antoni Silvestrovic is committed to ensuring that the app is as useful
      ...
      <p>
        The rythmic app stores and processes personal data that you have
        ...
        features and it could mean that the rythmic app won’t work properly or
        at all.
      </p>
      <p>
        You should be aware that there are certain things that Antoni
        Silvestrovic will not take responsibility for. Certain functions of the
        ...
        but Antoni Silvestrovic cannot take responsibility for the app not
      ...
      <p>
        Along the same lines, Antoni Silvestrovic cannot always take
        ...
        turn it on to avail the Service, Antoni Silvestrovic cannot accept
        responsibility.
      </p>
      <p>
        With respect to Antoni Silvestrovic’s responsibility for your use of the
        ...
        we can make it available to you. Antoni Silvestrovic accepts no
      ...
      <p>
        ...
        keep using the app. Antoni Silvestrovic does not promise that it will
      ...
      <p>These terms and conditions are effective as of 2020-09-08</p>
      <h2>Contact Us</h2>
      <p>
...
export default RythmicTermsAndConditions
