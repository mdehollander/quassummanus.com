  ...
  return (
    <article className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="This is privacy policy page for rythmic app."
        />
      </Head>
      <h1>Rythmic Privacy Policy</h1>
      <h2 className={styles.header2}>Privacy Policy</h2>
      <p>
      ...
      <h2 className={styles.header2}>Information Collection and Use</h2>
      <p>
      ...
      <h2 className={styles.header2}>Log Data</h2>
      <p>
      ...
      <h2 className={styles.header2}>Cookies</h2>
      <p>
      ...
      <h2 className={styles.header2}>Links to Other Sites</h2>
      <p>
      ...
      <h2 className={styles.header2}>Changes to This Privacy Policy</h2>
      <p>
